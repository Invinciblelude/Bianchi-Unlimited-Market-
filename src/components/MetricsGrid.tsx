...
const metrics = [
  {
    ...
    value: '$70M',
    sublabel: '7% of Gross Revenue',
    trend: '+15%',
    trendUp: true,
  },
  {
    icon: Percent,
    label: 'Marketing Spend Rate',
    value: '7-10%',
    sublabel: 'Industry Premium Tier',
    trend: 'Optimal',
    trendUp: true,
  },
  {
      ...
      <div className="metrics-container">
        ...
        >
          ...
          <p className="metrics-description">
            Strategic marketing allocation for billion-dollar scale operations
          </p>
        </motion.div>
          ...
          {metrics.map((metric, index) => (
            ...
            >
              <div className="metric-card-header">
                ...
                <span className={`metric-trend ${metric.trendUp ? 'trend-up' : ''}`}>
                  {metric.trend}
                </span>
              </div>
